...
enum StatusKind: String, CaseIterable, Identifiable {
    ...
    var art: String {
        switch self {
        case .burn: DuatArt.Status.burn
        case .bleed: DuatArt.Status.bleed
        case .poison: DuatArt.Status.poison
        case .judgement: DuatArt.Status.judgement
        case .stagger: DuatArt.Status.frost
        case .mark: DuatArt.Status.marked
        case .evade: DuatArt.Status.evade
        case .regeneration: DuatArt.Status.regeneration
        case .shield: DuatArt.Status.shield
        case .armour: DuatArt.Status.armour
        case .champion: DuatArt.Status.champion
        }
    }
