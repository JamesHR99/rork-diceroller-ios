...
enum GodCatalog {
    ...
    static let ra: [GodBoonDef] = [
        ...
        GodBoonDef(
            ...
            slot: .attack,
            name: "Sun's Edge",
            effect: "All Attacks against an already Burning primary target gain +%V% damage. Each Attack adds 1 Burn per ingredient, maximum 3 per action.",
            function: "Same-face attack",
            kind: .regular,
            trigger: .everyAttack,
        ...
        GodBoonDef(
            ...
            slot: .utility,
            name: "Banked Embers",
            effect: "Resolve a 4–6 die Attack to gain one extra reroll pass next round, once per round; total pass maximum 3. Fixed.",
            function: "Same-face utility",
            kind: .regular,
            trigger: .firstLargeCombo,
    ...
    static let anubis: [GodBoonDef] = [
        ...
        GodBoonDef(
            ...
            slot: .utility,
            name: "Last Measure",
            effect: "Resolve actions using all six physical dice this round to earn one extra reroll pass next round, maximum 3. Wind-up alone is insufficient. Fixed.",
            function: "Same-face utility",
            kind: .regular,
            trigger: .roundEnd,
            payload: BoonPayload(rerollsNext: 1),
    ...
    static let bastet: [GodBoonDef] = [
        ...
        GodBoonDef(
            ...
            slot: .utility,
            name: "Light Feet",
            effect: "First successful Dodge each round earns one extra reroll pass next round, total maximum 3. Fixed.",
            function: "Same-face utility",
            kind: .regular,
            trigger: .onDodge,
            payload: BoonPayload(rerollsNext: 1)
    ...
    static let duos: [GodBoonDef] = [
        ...
        GodBoonDef(
            ...
            effect: "First Judgement release on an already Bleeding foe heals 3 and earns one reroll pass next round, maximum 3. Evaluate Bleed before the verdict even if it kills.",
