...
struct ShopView: View {
    ...
    private var rail: some View {
        VStack(alignment: .leading, spacing: 8) {
            HStack(spacing: 7) {
                PharaohSWagerSymbol(art: StageKind.ferryman.artName, fallback: "ferry.fill",
            ...
            Button {
                ...
                HStack(spacing: 6) {
                    PharaohSWagerIcon(name: PharaohSWagerArt.utilityCodex, size: 20)
                    Text("CODEX")
            ...
            VStack {
                ...
                HStack {
                    ZStack(alignment: .bottom) {
                        ...
                        PharaohSWagerImage(name: PharaohSWagerArt.strawEffigy, height: 62, fit: .fit)
