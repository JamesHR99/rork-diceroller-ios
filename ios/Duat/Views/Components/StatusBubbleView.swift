...
struct StatusBubbleView: View {
    ...
    private var header: some View {
        HStack(spacing: 7) {
            DuatSymbol(art: kind.art, fallback: kind.fallbackSymbol, size: 20, tint: kind.tint)
            ...
            if let patron = kind.patron {
                DuatSymbol(art: patron.artName, fallback: patron.symbol, size: 15, tint: patron.tint)
...
struct ChiselBubbleView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 7) {
            HStack(spacing: 7) {
                DuatSymbol(art: chisel.artName, fallback: "hammer.fill",
